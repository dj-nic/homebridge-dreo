...
exports.DreoPlatform = void 0;
const settings_1 = require("./settings");
const FanAccessory_1 = require("./accessories/FanAccessory");
const HeaterAccessory_1 = require("./accessories/HeaterAccessory");
const HumidifierAccessory_1 = require("./accessories/HumidifierAccessory");
const DehumidifierAccessory_1 = require("./accessories/DehumidifierAccessory");
const DreoAPI_1 = __importDefault(require("./DreoAPI"));
/**
 * HomebridgePlatform
...
class DreoPlatform {
    constructor(log, config, api) {
        ...
        this.webHelper = new DreoAPI_1.default(this);
        ...
        for (const device of dreoDevices) {
            ...
            switch (modelPrefix) {
                ...
                case 'DR-HAP':
                    ...
                    accessory.category = 3 /* FAN */;
                    new FanAccessory_1.FanAccessory(this, accessory, state);
                    break;
                case 'DR-HSH':
                case 'WH':
                    // Heater
                    accessory.category = 20 /* AIR_HEATER */;
                    new HeaterAccessory_1.HeaterAccessory(this, accessory, state);
                    break;
                case 'DR-HAC':
                    // Air Conditioner
...
exports.DreoPlatform = DreoPlatform;
