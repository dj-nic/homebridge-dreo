...
class FanAccessory extends BaseAccessory_1.BaseAccessory {
    constructor(platform, accessory, state) {
        ...
        this.currState.maxSpeed =
            accessory.context.device.controlsConf.control.find((params) => params.type === 'Speed').items[1].text;
        ...
        if (state.lighton !== undefined && state.brightness !== undefined) {
            ...
            this.lightService.setCharacteristic(this.platform.Characteristic.Name, accessory.context.device.deviceName + ' Light');
            this.lightService
                    ...
                    Object.keys(data.reported).forEach((key) => {
                        ...
                        switch (key) {
                            ...
                            case 'lighton':
                                ...
                                (_a = this.lightService) === null || _a === void 0 ? void 0 : _a.getCharacteristic(this.platform.Characteristic.On).updateValue(this.currState.lightOn);
                                this.platform.log.debug('Light on:', data.reported.lighton);
                                break;
                            case 'brightness':
                                this.currState.brightness = data.reported.brightness;
                                (_b = this.lightService) === null || _b === void 0 ? void 0 : _b.getCharacteristic(this.platform.Characteristic.Brightness).updateValue(this.currState.brightness);
